...
class camera:
    ...
    def tranformation_depthanything_gauss(self, depthmap_IA, liste_prof, img_prof, rob=3):
        ...
        inc, v, wi, B_calc,s0=self.gauss_markov(Qll, A, B)
        ...
        return A, B,Qll, inc, wi, v, X, B_calc,s0
